...
SQL by the SQL function name, in this case `str_concat`. This name
might be the same as the variable name in your Python project, but in
`CREATE FUNCTION` can give it an arbitrary name.
